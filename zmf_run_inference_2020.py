...
parser.add_argument('--pretrained', metavar='PTH',
                    default='./flying_chairs/DFC/flownetc,adam,300epochs,b64,lr0.0001/model_best.pth.tar', help='path to pre-trained model')
parser.add_argument('--output', '-o', metavar='DIR',
                    default='./model_test/flownetc/dfc/', help='path to output folder. If not set, will be created in data folder')
